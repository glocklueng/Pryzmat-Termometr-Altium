    ...
    <HTML>
      <BODY>
        <TABLE style="font:8pt MS Sans Serif" border="1" CELLSPACING="0" CELLPADDING="1" BGCOLOR="#FFFFFF">
          ...
          <TR valign="top">
            <TD align="left">
              <xsl:value-of select="@ADC_channels"/>
              <xsl:if test="@ADC_channels[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@ComponentLink4Description"/>
              <xsl:if test="@ComponentLink4Description[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@ComponentLink4URL"/>
              <xsl:if test="@ComponentLink4URL[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@CompType"/>
              <xsl:if test="@CompType[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@DatasheetDocument"/>
              <xsl:if test="@DatasheetDocument[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@DrillSize"/>
              <xsl:if test="@DrillSize[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              ...
              <xsl:if test="@Flash[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@fmax"/>
              <xsl:if test="@fmax[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@GPIOs"/>
              <xsl:if test="@GPIOs[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@High_Reliability"/>
              <xsl:if test="@High_Reliability[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@I2C"/>
              <xsl:if test="@I2C[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@PackageDocument"/>
              <xsl:if test="@PackageDocument[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@PackageTopMarking"/>
              <xsl:if test="@PackageTopMarking[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@PLL"/>
              <xsl:if test="@PLL[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@PowerWise"/>
              <xsl:if test="@PowerWise[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              ...
              <xsl:if test="@SPI[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@SRAM"/>
              <xsl:if test="@SRAM[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@Timers"/>
              <xsl:if test="@Timers[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@UART"/>
              <xsl:if test="@UART[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@VDD__max_"/>
              <xsl:if test="@VDD__max_[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@VDD__min_"/>
              <xsl:if test="@VDD__min_[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@VDD__typ_"/>
              <xsl:if test="@VDD__typ_[.='']">&#160;</xsl:if>
            </TD>
          </TR>
          </xsl:for-each>
        </TABLE>
